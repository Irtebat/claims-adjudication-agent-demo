"""silver.defect_codes: incremental serve-down data with Change Data Feed, managed by Lakeflow."""
...
@dp.table(
    name=f"`{catalog}`.silver.defect_codes",
...
def dataset():
    ...
    return (
        ...
        .load(f"/Volumes/{catalog}/bronze/raw_landing/defect_codes")
        .drop("_rescued_data")
    )
